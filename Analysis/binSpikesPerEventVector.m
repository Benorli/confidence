function [binnedSpikes, bin, eventIdx, binWidth, binEdges] = binSpikesPerEventVector(varargin)
% BINSPIKEPEREVENTVECTOR Takes a time window, surrounding each event and
...
%
%   [spikeTimesFromEvent] = binSpikesPerEventVector(spikeTimes, eventTimes)
